...
export type ActivityId = 'files' | 'git' | 'chat' | 'search' | 'memory' | 'codesearch' | 'tasks' | 'audit' | 'archdoc' | 'agent' | 'swarm' | 'debug' | 'outline' | 'notepads' | 'usage' | 'map' | 'github' | 'env' | 'wizard' | 'monitor' | 'ideation' | 'settings'
